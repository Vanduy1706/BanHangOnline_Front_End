...
// Create a context for observers
const ProductContext = createContext();

// Custom hook to subscribe to product updates
export const useProductObserver = () => useContext(ProductContext);
...
const TypeProductPage = () => {
    ...
    // Notify observers when products or pagination changes
    useEffect(() => {
        notifyObservers({ products: product, pagination: panigate });
    }, [product, panigate]);
    ...
    return (
        <ProductContext.Provider value={{ addObserver, removeObserver }}>
